...
//			pro1.setEmployee(Arrays.asList(emp1, emp2));
//			pro2.setEmployee(Arrays.asList(emp3));
//			pro3.setEmployee(Arrays.asList(emp1, emp2));
//			pro4.setEmployee(Arrays.asList(emp1, emp2, emp3));
//			
//			
//			// need to set both sides of the relationship manually
